...
public static class ExpressionExtensions
{
    ...
    /// <returns>
    ///     The expression where first argument is second argument from source expression
    ///     and second argument is first argument from source expression
    /// </returns>
    ...
    /// <summary>
    ///     Translate source <paramref name="expression" /> with two arguments to expression with type where arguments are
    ///     property of that type
    /// </summary>
    /// <typeparam name="T1">The type of first argument</typeparam>
    /// <typeparam name="T2">The type of second argument</typeparam>
    /// <typeparam name="T">
    ///     The type of argument of resulting expression. it must have at least two properties of types
    ...
    /// <param name="expression">The expression with one argument of type <typeparamref name="T" /></param>
    /// <returns>The expression with one argument of type <typeparamref name="T" />.</returns>
    public static Expression<Func<T, TResult>> SplitParameters<T1, T2, T3, T, TResult>(
